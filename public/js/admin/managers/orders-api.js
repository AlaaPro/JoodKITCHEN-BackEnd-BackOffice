...
class OrdersManager {
    ...
    updateStatsCards(stats) {
        ...
        if (pendingCard) {
            ...
            console.log('✅ Updated pending:', stats.pending);
        }
        if (preparingCard) {
            preparingCard.textContent = stats.preparing;
            console.log('✅ Updated preparing:', stats.preparing);
        }
        if (completedCard) {
            completedCard.textContent = stats.completed;
            console.log('✅ Updated completed:', stats.completed);
        }
        if (revenueCard) {
            revenueCard.textContent = `${stats.todayRevenue.toFixed(2)}€`;
            console.log('✅ Updated revenue:', stats.todayRevenue.toFixed(2) + '€');
        }
    }
    ...
    updatePagination(pagination) {
        ...
        if (totalText) {
            ...
            totalText.textContent = `Affichage de ${start} à ${end} sur ${pagination.total} commandes`;
        }
